...
public class Weather__2 implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = -7205630342076435991L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Weather__2) == false) {
            return false;
        }
        Weather__2 rhs = ((Weather__2) other);
